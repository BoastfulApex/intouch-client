...
const Thanks = () => {
    ...
    return (
        <div className={`popup ${popup.value === "thanks" ? "active" : ""}`} id="order">
            <div className="popup-overlay popup-close" onClick={() => dispatch(setPopup(""))}> </div>
            <div className="popup-inner order thanks">
                ...
                <div className="order__title">Спасибо за заявку</div>
                <p className='thanks__p'>Наши специалисты свяжутся с вами в ближайшее время</p>
            </div>
        </div>
    )
}
